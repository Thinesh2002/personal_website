  ...
  return (
    <section className="container mx-auto py-20 grid md:grid-cols-2 gap-14 items-center">
      ...
      <div className="relative flex justify-center">
        {/* Glow */}
        <div className="absolute w-82 h-82 rounded-full bg-orange-500/30 blur-2xl"></div>

        {/* Profile Image */}
        <img
          src={profileImg}
          alt="Thineshkaran Sureshkaran"
          className="relative w-74 h-74 rounded-full object-cover border-4 border-orange-500 shadow-xl"
        />
      </div>
